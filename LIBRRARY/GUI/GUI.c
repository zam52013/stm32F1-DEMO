...
void LCD_Fill(u16 sx, u16 sy, u16 ex, u16 ey, u16 color)
{
    ...
    Lcd_SetRegion(0, 0, lcddev.width - 1, lcddev.height - 1); //恢复窗口设置为全屏
}
...
void LCD_ShowChar(u16 x, u16 y, u16 fc, u16 bc, u8 num, u8 size, u8 mode)
{
    ...
    Lcd_SetRegion(0, 0, lcddev.width - 1, lcddev.height - 1); //恢复窗口为全屏
}
...
void Gui_Drawbmp16(u16 x, u16 y, const unsigned char *p) //显示40*40 QQ图片
{
    ...
    Lcd_SetRegion(0, 0, lcddev.width - 1, lcddev.height - 1); //恢复显示窗口为全屏
